...
namespace FileEncryptor
{
    public partial class Form1 : Form
    {
        ...
        {
            _folderBrowserDialog.ShowHiddenFiles = false;
            _folderBrowserDialog.Description = Notification.SELECT_A_FOLDER;
        ...
        {            
            ...
            {
                string selectedEncryptFolderPath = _folderBrowserDialog.SelectedPath;
        ...
        private void btnFolderBrowserDecrypt_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                string selecteddecryptFolderPath = _folderBrowserDialog.SelectedPath;
